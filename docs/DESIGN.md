...
> Design notes for **fintech-openai-gateway-adr** — a runnable typescript example that A typed payment risk boundary that routes optional explanations through an OpenAI-compatible gateway.
...
- **Feature code** — the actual task: payment-risk-review.
